...
public class PatrolMessagePipeline extends ChannelInitializer<SocketChannel> {

    private PatrolInboundHandler inboundHandler;

    public PatrolMessagePipeline() {
        inboundHandler = new PatrolInboundHandler();
    }
