...
/**
 * Class helps the ControllerDriver listen to connections related to the Client
 */
public class ControllerMessageRouter {

    private EventLoopGroup bossGroup;
    private EventLoopGroup workerGroup;
    private ServerBootstrap bootstrap;
    private ControllerMessagePipeline pipeline;
    private Map<Integer, ChannelFuture> ports = new HashMap<>();


    public ControllerMessageRouter(String configuration) {
        bossGroup = new NioEventLoopGroup();
        workerGroup = new NioEventLoopGroup(4);
        pipeline = new ControllerMessagePipeline(configuration);
...
//    public ControllerMessageRouter(int readBufferSize, int maxWriteQueueSize) {
//        /* Ignoring parameters ... */
//        this();
//    }
