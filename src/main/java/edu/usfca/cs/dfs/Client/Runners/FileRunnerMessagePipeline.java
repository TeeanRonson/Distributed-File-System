...
public class FileRunnerMessagePipeline extends ChannelInitializer<SocketChannel> {

    private FileRunnerInboundHandler inboundHandler;

    public FileRunnerMessagePipeline() {
        inboundHandler = new FileRunnerInboundHandler();
    }
