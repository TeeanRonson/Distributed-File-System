...
public class ClientInboundHandler extends SimpleChannelInboundHandler<Sm.StorageMessageWrapper> {
    ...
    public void channelRead0(ChannelHandlerContext ctx, Sm.StorageMessageWrapper msg) {
        ...
        System.out.println("ChannelRead0 in Client");
...
//        resps.add(msg);
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        System.out.println("ChannelRead in Client");
