...
public class HeartBeatMessagePipeline extends ChannelInitializer<SocketChannel> {

    private HeartBeatInboundHandler inboundHandler;

    public HeartBeatMessagePipeline() {
        inboundHandler = new HeartBeatInboundHandler();
    }
