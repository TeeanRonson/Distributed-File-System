...
public class FileRecoveryRunnerInboundHandler extends SimpleChannelInboundHandler<Sm.StorageMessageWrapper> {

    private Channel channel;
    private Sm.StorageMessageWrapper resp;
    BlockingQueue<Sm.StorageMessageWrapper> resps = new LinkedBlockingQueue<>();
    public FileRecoveryRunnerInboundHandler() {

    }

    public Sm.StorageMessageWrapper request(Sm.StorageMessageWrapper msg) {

        System.out.println("Sending a Relay");
