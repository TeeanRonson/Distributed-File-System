...
public class FileRecoveryRunnerMessagePipeline extends ChannelInitializer<SocketChannel> {

    private FileRecoveryRunnerInboundHandler inboundHandler;

    public FileRecoveryRunnerMessagePipeline() {
        inboundHandler = new FileRecoveryRunnerInboundHandler();
    }
