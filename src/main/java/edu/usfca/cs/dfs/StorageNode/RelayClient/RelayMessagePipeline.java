...
public class RelayMessagePipeline extends ChannelInitializer<SocketChannel> {

    private RelayInboundHandler inboundHandler;

    public RelayMessagePipeline() {
        inboundHandler = new RelayInboundHandler();
    }
